    ...
    template="""
        <mujoco>
            <asset>
                ...
                <mesh name="geltip_shell" file="meshes/shell.stl" scale="0.001 0.001 0.001"/>
                <mesh name="geltip_base" file="meshes/base.stl" scale="0.001 0.001 0.001"/>
            
                <!-- the glass -->
                <!--<mesh name="geltip_glass" file="meshes/tube.stl" scale="0.001 0.001 0.001"/>-->
                
                <!-- the outter elastomer, for visual purposes -->
                <mesh name="geltip_elastomer" file="meshes/Membrane_shell.stl" scale="0.001 0.001 0.001" />  
            ...
            <worldbody>
                <body name="geltip">
                   ...
                   <!-- <geom density="0.1" type="mesh" mesh="geltip_shell" material="black_plastic" pos="-0.0 -0.0 -0.0" />-->
                   <!-- <geom density="0.1" type="mesh" mesh="geltip_base" material="black_plastic" pos="-0.0 -0.0 -0.0" />-->
                    <camera name="camera" pos="0 0 0" xyaxes="0 1 0 0 0 -1 " fovy="100"/>
