...
if __name__ == "__main__":
    ...
    model.load_state_dict(torch.load('models/minkunet_model_MAE_force_final.pth')) 
    model.eval()
    
    if not os.path.exists("Test_Data/Prediction_Force_unseen"):
        os.makedirs("Test_Data/Prediction_Force_unseen")

    prediction_path = 'Test_Data/Prediction_Force_unseen'
    test_data_path = 'Test_Data/Input_Force_unseen'
    ...
    total_error_x_sum = 0.0
    total_error_y_sum = 0.0
    total_error_z_sum = 0.0
    num_samples = 0
