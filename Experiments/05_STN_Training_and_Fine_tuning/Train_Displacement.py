...
class CustomDataset(torch.utils.data.Dataset):
    def __init__(self, data_folder):
        ...
        self.input_files = sorted([f for f in os.listdir(os.path.join(data_folder, 'Train_Data/Input_Displacement_10indenter')) if f.endswith('.npy')])
        self.gt_files = sorted([f for f in os.listdir(os.path.join(data_folder, 'Train_Data/Ground_Truth_Displacement_10indenter')) if f.endswith('.npy')])
    ...
    def __getitem__(self, idx):
        input_path = os.path.join(self.data_folder, 'Train_Data/Input_Displacement_10indenter', self.input_files[idx])
        gt_path = os.path.join(self.data_folder, 'Train_Data/Ground_Truth_Displacement_10indenter', self.gt_files[idx])
...
## multiprocessing_context='spawn'
    ...
    plt.grid(True)
    plt.legend()
    plt.savefig('validation_loss_curve_MAE_displacement_final_0.9mm_initial_npy_0.9_10indenters.png')
    #plt.show()

    # Saving and loading a network
    torch.save(net.state_dict(), 'minkunet_model_MAE_displacement_final_0.9mm_initial_npy_0.9_10indenters.pth')
