...
class CustomDataset(torch.utils.data.Dataset):
    def __init__(self, data_folder):
        ...
        self.gt_files = sorted([f for f in os.listdir(os.path.join(data_folder, 'Train_Data/Ground_Truth_Force_10indenter')) if f.endswith('.npy')])
    ...
    def __getitem__(self, idx):
        ...
        gt_path = os.path.join(self.data_folder, 'Train_Data/Ground_Truth_Force_10indenter', self.gt_files[idx])
...
## multiprocessing_context='spawn'
    ...
    plt.grid(True)
    plt.legend()
    plt.savefig('validation_loss_curve_MAE_force_final_0.9mm_initial_npy_0.9_10indenter.png')
    plt.show()

    # Saving and loading a network
    torch.save(net.state_dict(), 'minkunet_model_MAE_force_final_0.9mm_initial_npy_0.9_10indenter.pth')
