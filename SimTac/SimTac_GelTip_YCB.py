...
# choice = 'orange', 'screwdriver', 'strawberry'
parser.add_argument("--object", default="strawberry") # indenter shape
parser.add_argument("--translation_x", type=float, default=20) 
parser.add_argument("--translation_y", type=float, default=20) 
parser.add_argument("--translation_z", type=float, default=10) 
parser.add_argument("--depth_X", type=float, default=-2.5) 
parser.add_argument("--indenter_velocity", type=float, default=40)
...
parser.add_argument("--rotation_y", type=int, default=0) 
...
parser.add_argument("--displacement_interval", type=float, default=0.1)
...
obj_name = "libs/obj_" + args.particle + "_YCB/" + args.object + ".npy"
...
while window.running:
  while True:     
    ...
    camera.position(35, 120, 24)
    camera.lookat(35, 30, 24)
    camera.up(0, 0, -1)
    scene.set_camera(camera)
    scene.point_light(pos=(60, 100, 44), color=(0.3, 0.3, 0.3))
