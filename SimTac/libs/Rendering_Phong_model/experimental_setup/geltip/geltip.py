## Please check the unit of the stl file
## You can first finish the assembling work in Solidworks and then output the stl file of the assembling model, where the relative position will be recorded in stl
    ...
    template="""
        <mujoco>
            <asset>
                ...
                <mesh name="geltip_shell" file="meshes_new/shell.stl" scale="0.001 0.001 0.001"/>
                <mesh name="geltip_base" file="meshes_new/base.stl" scale="0.001 0.001 0.001"/>
        
                
                <!-- the outter elastomer, for visual purposes -->
                <mesh name="geltip_elastomer" file="meshes_new/elastomer.stl" scale="0.001 0.001 0.001"/>  
                
                <!-- inverted mesh, for limiting the depth map-->
                <!-- changing this mesh changes the depth maps -->
                <mesh name="geltip_elastomer_inv" file="meshes_new/elastomer_shell_low_density.stl" scale="0.001 0.001 0.001"/>
        
            </asset>
            <worldbody>
                <body name="geltip">
                    
                    <geom density="0.1" type="mesh" mesh="geltip_shell" material="black_plastic" pos="-0.03574064 -0.0001959 -0.00019592"/>
                    <geom density="0.1" type="mesh" mesh="geltip_base" material="black_plastic" pos="-0.03574064 -0.0001959 -0.00019592"/>
                    <camera name="camera" pos="0.0151 0.0151 0.0043" zaxis="0 0 -1" fovy="100"/>
